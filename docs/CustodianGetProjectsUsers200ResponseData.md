...
**data** | [**Array&lt;CustodianGetProjectsUsers200ResponseDataDataInner&gt;**](CustodianGetProjectsUsers200ResponseDataDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { CustodianGetProjectsUsers200ResponseData } from '@hdruk/safepeopleregistry-api-sdk';

const instance: CustodianGetProjectsUsers200ResponseData = {
    current_page,
    per_page,
    total,
    data,
