...
**data** | [**Array&lt;OrganisationGetUsers200ResponseDataDataInner&gt;**](OrganisationGetUsers200ResponseDataDataInner.md) |  | [optional] [default to undefined]
...
```typescript
import { OrganisationGetUsers200ResponseData } from '@hdruk/safepeopleregistry-api-sdk';

const instance: OrganisationGetUsers200ResponseData = {
    current_page,
    data,
    first_page_url,
    from,
