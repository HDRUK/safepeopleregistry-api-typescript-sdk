...
**data** | [**Array&lt;Experience&gt;**](Experience.md) |  | [optional] [default to undefined]
...
```typescript
import { ExperienceIndex200ResponseData } from '@hdruk/safepeopleregistry-api-sdk';

const instance: ExperienceIndex200ResponseData = {
    current_page,
    per_page,
    total,
    data,
