...
**data** | [**Array&lt;Organisation&gt;**](Organisation.md) |  | [optional] [default to undefined]
...
```typescript
import { CustodianGetOrganisations200ResponseData } from '@hdruk/safepeopleregistry-api-sdk';

const instance: CustodianGetOrganisations200ResponseData = {
    current_page,
    per_page,
    total,
    data,
